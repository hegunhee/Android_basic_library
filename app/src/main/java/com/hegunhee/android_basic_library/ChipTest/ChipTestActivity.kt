...
class ChipTestActivity : AppCompatActivity() {
    ...
    private val binding: ActivityChipTestBinding by lazy {
        ActivityChipTestBinding.inflate(
            layoutInflater
        )
    }
    ...
    private fun initListener() = with(binding) {
        button.setOnClickListener {
            Toast.makeText(this@ChipTestActivity, chipGroup.checkedChipIds.map {
                root.findViewById<Chip>(it).text.toString()
